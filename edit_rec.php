...
if ($_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    do {
        if ( empty($recipient_id) || empty($first_name) || empty($last_name) || empty($contact_number) || empty($street) || empty($city) || empty($postal_code) ) {
...
<body>
    <div class= "cont my-5">
        ...
        ?>
        <form method="post" >
            <input type="hidden" name="recipient_id" value="<?php echo $recipient_id; ?>"></input>
            <div class="row mb-3">
