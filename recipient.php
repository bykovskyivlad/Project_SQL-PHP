...
<body>
    <div class="recipient">
        ...
        <div class="d-flex gap-3 mb-3">
            <a class="btn btn-primary" href="/Poczta/create_rec.php" role="button">New recipient</a>
        ...
        <table class="table"> 
            <thead>
                <tr>
                    <th><a href="?sort=recipient_id&order=<?php echo isset($_GET['order']) && $_GET['order'] === 'ASC' ? 'DESC' : 'ASC'; ?>">Id</a></th>
            ...
            <tbody id="recipient-result">
                ...
                $sort = $_GET['sort'] ?? 'recipient_id'; // Domyślne sortowanie po recipient_id
                $order = $_GET['order'] ?? 'ASC'; // Domyślnie porządek rosnący

                // Walidacja parametrów
                $valid_columns = ['recipient_id', 'first_name', 'last_name', 'contact_number', 'street', 'city', 'postal_code'];
                ...
                $sql = "SELECT * FROM recipient WHERE 1=1";
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td>
                            <a class='btn btn-primary btn-sm' href='/Poczta/edit_rec.php?recipient_id=$row[recipient_id]'>Edit</a>
                            <a class='btn btn-danger btn-sm' href='/Poczta/delete_rec.php?recipient_id=$row[recipient_id]' onclick='return confirm(\"Czy na pewno chcesz usunąć tego klijenta?\")'>Delete</a>
                        </td>
                    </tr>";
                }
                ?>
        ...
        document.getElementById('filter-form').addEventListener('submit', function (e) {
            ...
            fetch('?' + new URLSearchParams(formData))
                ...
                .then(html => {
                    ...
                    const newResults = doc.querySelector('#recipient-result').innerHTML;
                    document.getElementById('recipient-result').innerHTML = newResults;
                });
        });
